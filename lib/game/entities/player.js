        ...
        ig.EntityPlayer = ig.global.EntityPlayer = ig.Player.extend({
            ...
            initProperties: function() {
                ...
                this.weaponAnims = {
                    ...
                    'anim_weapon4_idle': new ig.Animation( this.weaponSheet, 1, [0]),
                    'anim_weapon4_move': new ig.Animation( this.weaponSheet, 0.4, [0,1]),
                    'anim_weapon4_shoot': new ig.Animation( this.weaponSheet, 0.1, [2,3]),
                    'anim_weapon5_idle': new ig.Animation( this.weaponSheet, 1, [8]),
                    'anim_weapon5_move': new ig.Animation( this.weaponSheet, 0.4, [8,9]),
                    'anim_weapon5_shoot': new ig.Animation( this.weaponSheet, 0.1, [10,11]),
                    'anim_weapon6_idle': new ig.Animation( this.weaponSheet, 1, [12]),
                    'anim_weapon6_move': new ig.Animation( this.weaponSheet, 0.4, [12,13]),
                    'anim_weapon6_shoot': new ig.Animation( this.weaponSheet, 0.1, [14,15])
                };
