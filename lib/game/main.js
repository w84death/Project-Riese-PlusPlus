...
.defines(function () {
     ...
     var myGameClass = ig.GameExtended.extend({
        ...
        init: function () {
            ...
            //this.musicForest.stop();
            //if (this.director.currentLevel == 0) {
            this.musicForest.loop = true;
                this.musicForest.play();
            //}
            //console.log(this.director.currentLevel)

        },
         musicForest: new ig.Sound('media/sounds/forest.ogg'),
         //musicAlien: new ig.Sound('media/sounds/alien.*'),
         //musicBase: new ig.Sound('media/sounds/base.*'),
