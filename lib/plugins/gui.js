    ...
    draw: function(){
        ...
        if(STATE == 'menu'){
            ...
            if(menus[STATE].position == 1){
                this.fontColor.draw('HISCORE', this.menu.x, this.menu.y+24, ig.Font.ALIGN.CENTER );
            }else{
                this.fontWhite.draw('HISCORE', this.menu.x, this.menu.y+24, ig.Font.ALIGN.CENTER );
            }
        ...
        if(STATE == 'choose_map'){
           this.fontWhite.draw('- CHOOSE MAP -', this.top.x, this.top.y, ig.Font.ALIGN.CENTER );
            ...
            if(menus[STATE].position == 0){
                this.fontColor.draw('SANDBOX', this.menu.x, this.menu.y+12, ig.Font.ALIGN.CENTER );
            }else{
                this.fontWhite.draw('SANDBOX', this.menu.x, this.menu.y+12, ig.Font.ALIGN.CENTER );
            }

            if(menus[STATE].position == 1){
                this.fontColor.draw('EPISODE I', this.menu.x, this.menu.y+24, ig.Font.ALIGN.CENTER );
            }else{
                this.fontWhite.draw('EPISODE I', this.menu.x, this.menu.y+24, ig.Font.ALIGN.CENTER );
            }

            if(menus[STATE].position == 2){
                this.fontColor.draw('EPISODE II', this.menu.x, this.menu.y+36, ig.Font.ALIGN.CENTER );
            }else{
                this.fontWhite.draw('EPISODE II', this.menu.x, this.menu.y+36, ig.Font.ALIGN.CENTER );
            }


            if(menus[STATE].position == 3){
                this.fontColor.draw('EPISODE III', this.menu.x, this.menu.y+48, ig.Font.ALIGN.CENTER );
            }else{
                this.fontWhite.draw('EPISODE III', this.menu.x, this.menu.y+48, ig.Font.ALIGN.CENTER );
            }

            if(menus[STATE].position == 4){
