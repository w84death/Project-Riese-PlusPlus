    ...
    draw: function(){
        ...
        if(STATE == 'choose_map'){
           this.fontWhite.draw('- CHOOSE MAP -', this.top.x, this.top.y, ig.Font.ALIGN.CENTER );
            ...
            if(menus[STATE].position == 1){
                this.fontColor.draw('E1M1', this.menu.x, this.menu.y+24, ig.Font.ALIGN.CENTER );
            }else{
                this.fontWhite.draw('E1M1', this.menu.x, this.menu.y+24, ig.Font.ALIGN.CENTER );
            }

            if(menus[STATE].position == 2){
                this.fontColor.draw('E1M2', this.menu.x, this.menu.y+36, ig.Font.ALIGN.CENTER );
            }else{
                this.fontWhite.draw('E1M2', this.menu.x, this.menu.y+36, ig.Font.ALIGN.CENTER );
            }
        ...
        if(STATE == 'game'){
            ...
            if(player){
                ...
                if(player.reloadTimer.delta() < 0){
                    ...
                    reload = (((player.shoot.reload/10)*rtime)*100)<<0;
                }
